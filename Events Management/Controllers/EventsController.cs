...
namespace Events_Management.Controllers
{
    public class EventsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Subject,Message")] Event @event)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,Subject,Message")] Event @event)
        {
            if (id != @event.Id)
            {
                return NotFound();
